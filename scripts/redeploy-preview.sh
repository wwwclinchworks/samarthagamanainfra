...
# Snapshot commit: a80685f (last production before brand-copy rewrite)
set -euo pipefail
...
note = '''<div id="sgi-preview-banner" style="position:fixed;z-index:99999;left:0;right:0;top:0;padding:10px 16px;background:#1a1814;color:#f3eee4;font:600 13px/1.35 Inter,system-ui,sans-serif;text-align:center;letter-spacing:.02em">PREVIEW — previous site version for client comparison · <a href="https://www.samarthagamanainfra.com/" style="color:#c9a176">Open current site →</a></div><style>body{padding-top:44px !important}</style>'''
