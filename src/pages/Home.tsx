...
const parcels = [
  {
    ...
    num: "01",
    title: "Townships",
    desc: "Planned communities, laid out before the first foundation is set — schools, parks, and homes sequenced to grow together, not around each other.",
  ...
  {
    coord: "Parcel 04 / Sector PEB",
    num: "04",
    title: "PEB Wall Panels",
    highlight: true,
    desc: "Pre-Engineered Building wall panels — fast-erect steel structures for warehouses, factories, industrial sheds and commercial shells. One of our major businesses.",
    icon: "M6 38V14l18-8 18 8v24M6 38h36M14 38V22M22 38V18M30 38V22M38 38V26",
  },
  {
...
export function HomePage() {
  const [intro, setIntro] = useState(() => !introAlreadyDone() && !skipIntroOnDevice())
        ...
        <div className="container origin__grid">
          <div className="origin__text">
            ...
            <p>
              ...
              ambition — is what Samartha Gamana Infra brings to every township, tower, and PEB structure it builds. The house is
        ...
        <div className="container peb-spotlight">
          <div className="peb-spotlight__copy">
            ...
            <p>
              ...
              across Anantapur and Rayalaseema.
            </p>
            <p>
              PEB systems cut construction time, reduce site labour and deliver predictable quality. From factory-made
              panels to on-site assembly, we handle design coordination, fabrication and erection for clients who need
              usable floor area fast.
            </p>
            <p style={{ marginTop: "1.5rem" }}>
              <Link className="btn-magnetic" to="/what-we-do/peb">
        ...
        <div className="container">
          ...
          <div className="stats__grid">
            ...
            <div className="stat">
              ...
              <span className="stat__label">PEB projects delivered</span>
            </div>
            <div className="stat">
